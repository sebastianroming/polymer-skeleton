...
var SkApp = function (_PolymerElement) {
  _inherits(SkApp, _PolymerElement);

  function SkApp() {
    _classCallCheck(this, SkApp);

    return _possibleConstructorReturn(this, (SkApp.__proto__ || Object.getPrototypeOf(SkApp)).apply(this, arguments));
  }

  _createClass(SkApp, null, [{
    key: 'properties',
    get: function get() {
      return {
        name: {
...
var SkMenu = function (_PolymerElement) {
  _inherits(SkMenu, _PolymerElement);

  function SkMenu() {
    _classCallCheck(this, SkMenu);

    return _possibleConstructorReturn(this, (SkMenu.__proto__ || Object.getPrototypeOf(SkMenu)).apply(this, arguments));
  }

  _createClass(SkMenu, null, [{
    key: 'template',
    get: function get() {
...
var SkMenuItem = function (_PolymerElement) {
  _inherits(SkMenuItem, _PolymerElement);

  function SkMenuItem() {
    _classCallCheck(this, SkMenuItem);

    return _possibleConstructorReturn(this, (SkMenuItem.__proto__ || Object.getPrototypeOf(SkMenuItem)).apply(this, arguments));
  }

  _createClass(SkMenuItem, null, [{
    key: 'template',
    get: function get() {
      return '<style>' + _style2.default + '</style> ' + _template2.default;
    }
